@testset "pyapi" begin
    ...
    function _testsuite(api)
        @testset "Read API" begin
            ...
            #@test read_samples(api, "parameter-read", "example-estimate") == 1.0
            #@test read_samples(api, "parameter-read", "example-distribution") isa Real
            #@test read_samples(api, "parameter-read", "example-samples") ∈ [1, 2, 3]
